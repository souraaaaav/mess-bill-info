    ...
    return (
        <div>
            <div id="card-success" class="visible">
                ...
                <p style={{ color: 'green' }}>Sourav Debnath</p>
            </div>
            <div id="card-success" class="visible">
            ...
            <div id="form-container">
                ...
                <div id="card-front">
                    ...
                    <div id="image-container">
                        <span id="amount">Total Paying: <strong>1252৳</strong></span>
                        <span id="card-image">
                    ...
                    <div id="cardholder-container-up">
                        ...
                        <input type="text" id="card-holder" placeholder="137৳" />
                    </div>
                    ...
                    <div id="cardholder-container">
                        ...
                        <input type="text" id="card-holder" placeholder="Sourav Debnath" />
                    </div>
                    ...
                    <div id="exp-container">
                        ...
                        <input id="card-month" type="text" placeholder="13 May" length="2" />
